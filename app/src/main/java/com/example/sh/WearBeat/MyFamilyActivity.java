 ...
 *  이 클래스는 가족들의 진동패턴을 설정하기 위한 액티비티이다.
 */
public class MyFamilyActivity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.app_family);
        Intent intent=new Intent(this.getIntent());
        mLoadingContainer = findViewById(R.id.loading_container);
        mListView = (ListView) findViewById(R.id.listView1);


        myhelper =  new MySQLiteOpenHelperPerson(MyFamilyActivity.this, "person.db",null, 1);
        db = new Database_person(myhelper);

        TextView txtvew = (TextView)findViewById(R.id.addedPersonandVib);
        txtvew.setText(db.selectGroup(6));
        ...
        btn_intent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MyFamilyActivity.this, MyFriendActivity.class);
                startActivity(intent);
            }
        });
        Button btn_intent2;
        btn_intent2 = (Button)findViewById(R.id.job_btn);
        btn_intent2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyFamilyActivity.this, MyJobActivity.class);
                startActivity(intent);
            }
        });
        Button btn_intent3;
        ...
        btn_intent3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyFamilyActivity.this, MyPersonActivity.class);
                startActivity(intent);
            }
        });
    }
    ...
    /**
     * 사람이름별로 진동패턴을 받기위해 패턴설정을 위한 라디오 버튼 리스트
    ...
    private void DialogRadio(final String personName) {
        ...
        {
            AlertDialog.Builder alert = new AlertDialog.Builder(MyFamilyActivity.this);
           ...
           /* alt_bld.setTitle("진동을 선택하세요");
            ...
            db.PersonSetVibration(personName, 6, "OK");
            Toast.makeText(getApplicationContext(), personName + " 님이 추가되었습니다.", Toast.LENGTH_SHORT).show();
            reflesh();
