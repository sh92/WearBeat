...
public class MyFriendActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        myhelper =  new MySQLiteOpenHelperPerson(MyFriendActivity.this, "person.db",null, 1);
        db = new Database_person(myhelper);

        TextView txtvew = (TextView)findViewById(R.id.addedPersonandVib);
        txtvew.setText(db.selectGroup(16));



        Button btn_intent;
        btn_intent = (Button)findViewById(R.id.family_btn);
        btn_intent.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyFriendActivity.this, MyFamilyActivity.class);
        ...
        btn_intent2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyFriendActivity.this, MyJobActivity.class);
                startActivity(intent);
            }
        });
        Button btn_intent3;
        ...
        btn_intent3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MyFriendActivity.this, MyPersonActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void DialogRadio(final String personName) {
        ...
        {
            AlertDialog.Builder alert = new AlertDialog.Builder(MyFriendActivity.this);
           ...
           /* alt_bld.setTitle("진동을 선택하세요");
            ...
            db.PersonSetVibration(personName, 16, "OK");
            Toast.makeText(getApplicationContext(), personName + " 님이 추가되었습니다.", Toast.LENGTH_SHORT).show();
            reflesh();
